...
<div class="row">
	<div class="col-md-3">
		<div class="form-group">
			{{ HTML::linkAction('contacts.show', 'Back', $contact_id ,array('class' => 'btn btn-default')) }}
		</div>
	...
	<div class="col-md-9">
		...
		<ul class="nav nav-tabs" role="tablist">
			...
			<li><a href="#specifications" role="tab" data-toggle="tab">Task</a></li>
		...
		<div class="tab-content">
			...
			<div class="tab-pane tabbed-action-content" id="specifications">
				<div class="col-md-12">
					<div>
						{{ HTML::linkAction('contacts.createtask', 'New Task', $project->id )}}
					</div>
