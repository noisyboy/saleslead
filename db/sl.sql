...
INSERT INTO `contacts` VALUES (1,1,'ZAI FOO','52','RENCIE','AGBIN','BAUTISTA','ENGINEER',NULL,'2014-07-29 03:14:02','2014-07-29 03:14:02'),(2,1,'CHASE TECHNOLOGIES CORPORATION','5268 DISEL ST. PALANAN MAKATI CITY','DONATO','JAVID','ALDEA','PROGRAMMER',NULL,'2014-07-30 00:14:22','2014-07-30 00:14:22'),(3,1,'CHASE TECHNOLOGIES CORPORATION','5268 DISEL ST. PALANAN MAKATI CITY','RENCIE','AGBIN','BAUTISTA','MANAGER',NULL,'2014-07-31 00:24:59','2014-07-31 00:24:59'),(4,2,'CHASE TECHNOLOGIES CORPORATION','5268 DISEL ST. PALANAN MAKATI CITY','JUAN','DELA','CRUZ','MANAGER',NULL,'2014-07-31 02:35:16','2014-07-31 02:35:16');
...
DROP TABLE IF EXISTS `project_contact_statuses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `project_contact_statuses` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `project_contact_statuses` WRITE;
/*!40000 ALTER TABLE `project_contact_statuses` DISABLE KEYS */;
INSERT INTO `project_contact_statuses` VALUES (1,'FOR APPROVAL'),(2,'APPROVED'),(3,'DENIED');
/*!40000 ALTER TABLE `project_contact_statuses` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `project_contacts` (
  ...
  KEY `project_contacts_status_id_foreign` (`status_id`),
  ...
  CONSTRAINT `project_contacts_status_id_foreign` FOREIGN KEY (`status_id`) REFERENCES `project_contact_statuses` (`id`)
...
INSERT INTO `project_contacts` VALUES (6,2,1,1,'programmer',2,'2014-07-31 02:34:15','2014-07-31 02:34:15'),(7,2,4,1,'manager',2,'2014-07-31 02:35:30','2014-07-31 02:35:30');
...
INSERT INTO `projects` VALUES (2,1,2,1,'SAMPLE PROJECT','5268 DIESEL ST. PALANAN MAKATI CITY',1,8,1,1,0,1,'sample',1,2,'2014-07-27 19:46:22','2014-07-29 07:02:32'),(3,2,2,1,'NEW PROJECT','5268 DIESEL ST. PALANAN MAKATI CITY',1,8,1,1,0,1,'asdas',1,2,'2014-07-29 19:03:04','2014-07-31 06:06:12');
...
INSERT INTO `users` VALUES (1,'Rencie','Agbin','Bautista','4107M',1,'admin','$2y$10$Owk34JTCDJ/ynNdnu1nz..4GUtOS7ldWo6WjKEAEma1KfcAAVix0W',1,'rencie.bautista@yahoo.com','GVRDecuTPE5gTP1tP6bHHTTfWEz3wEp2ZZFSwNfLqLLkE6T0c7wbuQqj4Ye6','2014-07-26 04:27:48','2014-07-31 07:59:45'),(2,'Donato','Javid','Aldea','2',1,'don','$2y$10$bkrNNK6XR9/.wsf/4n0FeeNY82qYxZEhL.ZwkubCv8HjuCIQMLTW.',1,'donato@yahoo.com','RKv0iLTtfMz3gW6Q7f3hKs39wNENk9I3kMbP4APOQaGK1Z5FoXgScHbGsY4I','2014-07-29 03:06:55','2014-07-31 07:37:26');
...
-- Dump completed on 2014-08-01  0:02:24
