...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 01, 2014 at 01:00 PM
...
('2014_07_31_143125_add_contact_tagging_status', 6);
...
(9, 'manage_new_projects', 'Manage New Projects', '2014-07-31 16:00:00', '2014-07-31 16:00:00');
...
(3, 2, 2, 1, 'NEW PROJECT', '5268 DIESEL ST. PALANAN MAKATI CITY', 1, 8, 1, 1, 0, 1, 'asdas', 1, 2, '2014-07-29 19:03:04', '2014-07-31 06:06:12'),
(4, 1, NULL, NULL, '1', '1', 1, 8, 1, 1, 0, 1, '11', 1, 1, '2014-08-01 02:57:18', '2014-08-01 02:57:18');
...
INSERT INTO `project_contacts` (`id`, `project_id`, `contact_id`, `contractor_group_id`, `role`, `status_id`, `created_at`, `updated_at`) VALUES
(6, 2, 1, 1, 'programmer', 2, '2014-07-31 02:34:15', '2014-07-31 02:34:15'),
(7, 2, 4, 1, 'manager', 2, '2014-07-31 02:35:30', '2014-07-31 02:35:30'),
(8, 2, 3, 1, 'it', 3, '2014-07-31 21:55:24', '2014-08-01 01:25:04'),
(11, 2, 2, 1, 'asd', 2, '2014-07-31 23:31:34', '2014-08-01 01:24:52'),
(12, 2, 4, 1, '1', 3, '2014-08-01 00:21:09', '2014-08-01 01:25:02'),
(13, 2, 4, 2, 'sample', 2, '2014-08-01 01:33:59', '2014-08-01 01:34:46');
...
(1, 'Rencie', 'Agbin', 'Bautista', '4107M', 1, 'admin', '$2y$10$Owk34JTCDJ/ynNdnu1nz..4GUtOS7ldWo6WjKEAEma1KfcAAVix0W', 1, 'rencie.bautista@yahoo.com', 'SuhnIvSrC4OBG65rYYpN4lM7eJF3IDI8EhKI8E3Izv6i3f43VG0UwRcPA6Fb', '2014-07-26 04:27:48', '2014-08-01 02:57:29'),
(2, 'Donato', 'Javid', 'Aldea', '2', 1, 'don', '$2y$10$bkrNNK6XR9/.wsf/4n0FeeNY82qYxZEhL.ZwkubCv8HjuCIQMLTW.', 1, 'donato@yahoo.com', 'tMvOPmvIoZjnqBmsyHrv7OsgWSnYQ7gYDU7lNnRVCwFKWBKMoiFXgbUVCORX', '2014-07-29 03:06:55', '2014-08-01 02:58:39');
...
ALTER TABLE `project_contacts`
  ...
  ADD CONSTRAINT `project_contacts_status_id_foreign` FOREIGN KEY (`status_id`) REFERENCES `project_contact_statuses` (`id`);
